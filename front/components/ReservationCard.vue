...
.reservation__card__tittle p {
    margin-left: 30px;
}

.confirm__table {
    width: 100%;
    border-spacing: 0 10px; /* 行間に10pxのスペースを追加 */
}
