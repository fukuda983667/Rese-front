...
input {
    border: none; /* 枠線を消す */
    border-bottom: 2px solid #f4cb36; /* アンダーラインを追加 */
...
input:focus {
    border-bottom-color: #b69b3a; /* フォーカス時のアンダーラインの色を設定 */
}
...
button {
    ...
    background-color: #f4cb36; /* ボタンの背景色を設定 */
...
button:hover {
    background-color: #b69b3a; /* ホバー時の背景色を設定 */
}
</style>